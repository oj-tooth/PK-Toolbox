...
if __name__ == '__main__':
    ...
    def config_model():
        ...
        try:
            ...
            print("TypeError: \
                All parameters should be floating point numbers (e.g. 1.0).")
    ...
    Title_label = Label(
        my_window, text="PK Toolbox Console",
        bg="white smoke",
    ...
    comp_label = Label(
        my_window, text="No. Compartments [1/2]:", font=("Verdana 15 bold")
    )
    ...
    protocol_label = Label(
        my_window, text="Dosing Protocol [IVB/SC]:", font=("Verdana 15 bold")
    )
    ...
    button = Button(
        my_window, text="Add PK Model", font=("Verdana 14"), command=config_model
    )
    button.grid(row=5, column=5)
    # Add button to end configuration - This could trigger running the simulations.
    button = Button(
        my_window, text="Run Models", font=("Verdana 14"), command=my_window.quit
    )
