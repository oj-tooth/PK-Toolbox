...
def rhs(t, y, model):
    ...
    :param y: List containing concentration variables. The length is dependent on the
    protocol being used.
    ...
    If a peripheral compartment is not being used it will still exist but will remain 
    ...
    :param model: Takes the model class object to retrive input parameters from it.
    ...
    if model.compartments == 1: #Only using a cenrtal compartment so q_p1 will remain zero.
        Q_p1 = 0
        V_p1 = 1
    else:
